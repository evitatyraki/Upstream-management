    ...
    <div class="gantt-wrap">
      <div class="gantt">
        <div style="display:flex;height:40px;border-bottom:1px solid var(--border);position:relative;margin-left:340px;">
          ...
          <div style="position:absolute;left:${todayPct}%;top:0;bottom:0;width:1px;background:#F59E0B;opacity:.5"></div>
          <div style="position:absolute;left:${todayPct}%;top:8px;transform:translateX(-50%);background:#F59E0B;color:#0F172A;font-size:9px;font-weight:700;padding:2px 6px;border-radius:3px">TODAY</div>
        </div>
